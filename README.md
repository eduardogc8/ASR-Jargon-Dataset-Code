...
| :-- | :--- | :--- | :--- |:---------:| :---: | :---: | :---: | :---: |
| **English** | **CHiME-6** | Standard | `small` |   0.440   | **0.750** | 0.489 | 0.370 | 0.331 |
| | | | `medium` |   0.384   | 0.785 | 0.414 | 0.368 | 0.331 |
| | | | `large-v3` | **0.369** | 0.785 | **0.409** | **0.355** | **0.318** |
| | | Prompted | `small` | **0.325** | 0.430 | **0.393** | **0.301** | **0.257** |
| | | | `medium` |   0.388   | **0.417** | 0.441 | 0.369 | 0.319 |
| | | | `large-v3` |   0.344   | 0.746 | 0.433 | 0.329 | 0.287 |
...
| | **GLOBE** | Standard | `medium` |    TBA    | TBA | TBA | TBA | TBA |
| | | | `large-v3` | **TBA** | **TBA** | TBA | **TBA** | **TBA** |
| | | | `large-v3-turbo` |   TBA   | TBA | **TBA** | TBA | TBA |
| | | Prompted | `medium` | **TBA** | **TBA** | **TBA** | **TBA** | **TBA** |
| | | | `large-v3` |   TBA   | TBA | TBA | TBA | TBA |
| | | | `large-v3-turbo` |   TBA   | TBA | TBA | TBA | TBA |
